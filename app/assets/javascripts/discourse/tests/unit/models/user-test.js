...
module("Unit | Model | user", function (hooks) {
  ...
  test("subsequent calls to trackStatus and stopTrackingStatus increase and decrease tracking counter", function (assert) {
    const timezone = "UTC";
    this.clock = fakeTime("2100-01-01T08:00:00.000Z", timezone, true);
